    ...
    def __getTitle(self) -> str:
        ...
        for power, value in enumerate(self.coefficients):
            ...
            if power == 0:
                ...
                if isFirst:
                    if curCoeff == -1:
                        res += ( '-' + 'x' + get_superscript(power) )
                    elif curCoeff == 1:
                        res += ( 'x' + get_superscript(power) )
                    else:
                        res += (str(curCoeff) + 'x' + get_superscript(power))
                else:
                    if curCoeff == -1:
                        res += ('-' + 'x' + get_superscript(power))
                    elif curCoeff == 1:
                        ...
                        res += ('+' + str(curCoeff) + 'x' + get_superscript(power)) if curCoeff >= 0 else (str(curCoeff) + 'x' + get_superscript(power))
